// Common JS 
document.querySelectorAll('.watch-control, .controls a').forEach
...
document.querySelector('.bottom-x-control').addEventListener('click', () => {
    cube.style.transform = `rotateX(${x -= 20}deg) rotateY(${y}deg) rotateZ(${z})`
})
...
document.querySelector('.right-y-control').addEventListener('click', () => {
    cube.style.transform = `rotateX(${x}deg) rotateY(${y -= 20}deg) rotateZ(${z})`
})
...
const watchUpControl = document.querySelector('.watch-up-control')
...
const hideControl = () => {
    if (axisY === -280) {
        watchUpControl.classList.add('hideControl')
    } else{
        watchUpControl.classList.remove('hideControl')
    }
    ...
    if (axisX === 280) {
        ...
        watchRightpControl.classList.remove('hideControl')
    }
